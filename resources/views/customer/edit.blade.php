    ...
    <div class="flex-1 p-6">
        ...
        <form action="{{ route('customer.update', $customer->id_customer) }}" method="POST" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nomor_telepon" value="{{ $customer->nomor_telepon }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md dark:bg-gray-900 dark:text-gray-300" required>
            </div>
            <div class="mb-4">
